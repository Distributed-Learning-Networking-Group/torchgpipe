...
class BertLayerNorm(nn.Module):
    ...
    def extra_repr(self):
        return '{}'.format(self.hidden_size)
...
class BertEmbeddings(nn.Module):
    ...
    def __repr__(self):
        return 'BertEmbeddings({}, {}, {}, {}, {})'.format(
            self.vocab_size, self.hidden_size, self.max_position_embeddings, self.type_vocab_size, self.hidden_dropout_prob
        )
...
class BertSelfAttention(nn.Module):
    ...
    def __repr__(self):
        return 'BertSelfAttention({}, {}, {})'.format(
...
class BertPooler(nn.Module):
    def __init__(self, hidden_size):
        ...
        self.hidden_size = hidden_size
        self.dense_act = LinearActivation(self.hidden_size, self.hidden_size, act="tanh")
    ...
    def __repr__(self):
        return 'BertPooler({})'.format(self.hidden_size)


class BertAdd(nn.Module):
    def __init__(self, size):
        super(BertAdd, self).__init__()
        self.size = size
    ...
    def __repr__(self):
        return 'BertAdd({})'.format(self.size)
...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.embeddings = BertEmbeddings(config.vocab_size, config.hidden_size,
                                         config.max_position_embeddings, config.type_vocab_size, config.hidden_dropout_prob)
...
class CrossEntropyWrapper(nn.Module):
    def __init__(self, vocab_size):
        ...
        self.cross_entropy = CrossEntropyLoss(ignore_index=-1)
        self.vocab_size = vocab_size
